...
<div>
    ...
    <fieldset>
        ...
        <form id="importPackageChecker" action="?" method="get">
            ...
            <label for="regexp">
                (ex: <b>org\.springframework\..*</b> will match <u>org.springframework.jdbc.datasource; version="[3.2, 4)"</u>
            </label>
            <br>
            <br>
            ...
            <label for="version">
                (ex: <b>3.2.19</b> will match <u>org.springframework.jdbc.datasource; version="[3.2, 4)"</u>)
            </label>
            <br><br>
            ...
            <label for="matchVersionRangeMissing">
                ...
                (if checked will match: <u>org.springframework.jdbc.datasource</u>)
            </label>
            <br><br>
