...
<c:set var="title" value="JCR Console"/>
<head>
...
%>
    ...
    <fieldset>
        <legend>
            <strong>This is ${workspace}&nbsp;workspace</strong>&nbsp;(<a href="#switchWorkspace"
                                                                          onclick="document.getElementById('workspace').value='${switchToWorkspace}'; document.getElementById('action').value=''; document.getElementById('groovyForm').submit(); return false;">switch
        ...
        <form id="groovyForm" action="?" method="post">
            ...
            <p><input type="submit" value="Execute ([Ctrl+Enter])"
                      onclick="if (!confirm('WARNING: You are about to execute a script, which can manipulate the repository data or execute services in Jahia. Are you sure, you want to continue?')) { return false; }"/>
            </p>
        </form>
    </fieldset>
</div>
