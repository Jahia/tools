...
<c:if test="${active}">
	<p>The dumping of error and thread information to a file is currently <strong>ON</strong>.<br/>Click here to <a href="?active=false&toolAccessToken=${toolAccessToken}">disable error file dumper</a></p>
</c:if>
<c:if test="${not active}">
	<p>The dumping of error and thread information to a file is currently <strong>OFF</strong>.<br/>Click here to <a href="?active=true&toolAccessToken=${toolAccessToken}">enable error file dumper</a></p>
</c:if>
